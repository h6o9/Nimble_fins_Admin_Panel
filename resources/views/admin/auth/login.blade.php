            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="card card-primary">
                        <div class="card-header" style="padding: 16px 1px 16px 27px !important;">
                            ...
                            <img src="https://res.cloudinary.com/nimblefins/image/upload/c_limit,dpr_1.0,f_auto,h_1600,q_auto,w_1600/v1/UK/static/nimblefins-logo-png"
                    onerror="this.src='~/web/assets/images/logo/InsureDaily_short_term_car_insurance_logo.png'"
                    width="90%" height="59" alt="NimbleFins">
                            ...
                            <form method="POST" action="{{ url('admin/login') }}" class="needs-validation" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" type="email" placeholder="example@gmail.com" class="form-control" name="email" tabindex="1"
                                        required autofocus name="email" style=" --theme-color: #fab400">
                                    @error('email')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="position-relative">
                                        <input id="password" type="password" placeholder="password" class="form-control" name="password" style=" --theme-color: #fab400" required>
                                ...
                                <div class="form-group mb-0">
                                    <button type="submit" class="btn  btn-lg btn-block" tabindex="4" style="background-color: #fab400">
                                        Login
                                    </button>
                                </div>
                            </form>
