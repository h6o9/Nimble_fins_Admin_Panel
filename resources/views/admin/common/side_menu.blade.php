<div class="main-sidebar sidebar-style-2" style="background: #fff; ">
    ...
    <a href="{{url('admin/dashboard')}}"><img src="https://res.cloudinary.com/nimblefins/image/upload/c_limit,dpr_1.0,f_auto,h_1600,q_auto,w_1600/v1/UK/static/nimblefins-logo-png" class="admin-logo" style="width: 86%;" /></a>

        </div>
        <ul class="sidebar-menu">
    
            <li class="dropdown {{ request()->is('admin/dashboard') ? 'active' : '' }}">
                <a href="{{ url('/admin/dashboard') }}" class="nav-link" style="color:#000 ; "><i
                        data-feather="home"></i><span>Dashboard</span></a>
            </li>
            <li class="dropdown {{ request()->is('admin/insurance') ? 'active' : '' }}">
                <a href="{{ route('insurance.index') }}" class="nav-link" style="color:#000 ;">
                    <span> <i data-feather="shield"></i>Car Insurance</span>
                </a>
            </li>
            <li class="dropdown {{ request()->is('admin/user*') ? 'active' : '' }}">
                <a href="{{ route('user.index') }}" class="nav-link" style="color:#000 ;">
                    <span> <i data-feather="users"></i>Users</span>
                </a>
            </li>
            <li class="{{ request()->is('admin/faq*') ? 'active' : '' }}">
                <a href="{{ route('faq.index') }}" style="color:#000 ;"
            ...
            {{-- <li class="dropdown {{ request()->is('admin/company*') ? 'active' : '' }}">
                <a href="{{ route('company.index') }}" class="nav-link"><i
                        data-feather="users"></i><span>Company</span></a>
            </li>
